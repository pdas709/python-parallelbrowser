...
def test_profile_picture_section_Null_Validation(browser):
    # Add Item to cart
    ...
    null_alert = profile_picture_section_.get_null_alert()
    assert 'required' in null_alert, f"Test Failed: Alert did not match expected - required."  
