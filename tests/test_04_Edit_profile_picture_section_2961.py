...
def test_profile_picture_section(browser):
    # Add Item to cart
    ...
    #clear and edit the top most field
    profile_picture_section_.inputfield_profilepicturesection()
  
    #save the section
    profile_picture_section_.click_save_profilepicturesection()
    
    
    txt_from_inputttt = profile_picture_section_.get_input_text_and_verifyyyyy()
    assert initialize.profile_pictureSection in txt_from_inputttt, f"Test Failed: Input did not match expected."
