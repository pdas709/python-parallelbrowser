...
def test_Add_Work_Experience(browser):
    # Add Item to cart
    ...
    #Add Comapany Name
    work_experience_section_.type_companyname()
    work_experience_section_.type_job_title()
    work_experience_section_.job_dates()
    work_experience_section_.job_description()
    work_experience_section_.click_add()
    txt_from_inputt = work_experience_section_.get_input_text_and_verifyy()
    assert initialize.company in txt_from_inputt, f"Test Failed: Input did not match expected."
