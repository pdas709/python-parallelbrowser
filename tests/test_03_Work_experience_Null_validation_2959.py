...
def test_Work_Experience_Null_Validation_2646(browser):
    # Add Item to cart
    ...
    txt_from_alerttt = work_experience_section_.allertttt_text_and_verifyy()
    assert 'required' in txt_from_alerttt, f"Test Failed: Input did not match expected - required."
