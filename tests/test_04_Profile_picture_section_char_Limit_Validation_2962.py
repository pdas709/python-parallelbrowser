...
def test_profile_picture_section_Char_Limit(browser):
    # Add Item to cart
    ...
    profile_picture_section_.longinput_profilepicturesection()

    #save the section
    profile_picture_section_.click_save_profilepicturesection()
    
    char_limit_alert = profile_picture_section_.get_char_limit_alert()
    assert 'invalid' in char_limit_alert, f"Test Failed: Alert did not match expected - invalid."  
