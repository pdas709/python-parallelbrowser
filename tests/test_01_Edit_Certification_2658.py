...
class TestCertificate:
  ...
  def test__Edit_Certification(self,browser):
    ...
    #proceed with editing of the Certification section

    certification_ssection_ = CertificationBottomofpage(browser)
    certification_ssection_.click_edit_button_certification()
    
    certification_ssection_.cleartextfromcertification()

    certification_ssection_.edit_the_certification()

    certification_ssection_.clickaddcertification()

    txt_from_inputtttii = certification_ssection_.get_input_text_and_verifyyyii()
    assert initialize.editcert in txt_from_inputtttii, f"Test Failed: Input did not match expected"