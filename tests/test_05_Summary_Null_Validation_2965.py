...
def test_Summary_Null_Validation(browser):
    # Add Item to cart
    ...
    summary_section_.clearsummaryfield()

    summary_char_limit_text = summary_section_.verify_summary_null_alert()
    assert 'required' in summary_char_limit_text, f"Test Failed: Alert did not match expected - required."  
